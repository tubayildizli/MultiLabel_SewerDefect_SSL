...
sys.path.append('/scratch/tyldzl/PythonProject/sewer_defects_SSL/')
...
train_path="/scratch/tyldzl/data/Sewer_ML/images_tiles_224_pretrain/train_resized_100k"
val_path="/scratch/tyldzl/data/Sewer_ML/images_tiles_224_pretrain/val_resized_100k"
VisslDatasetCatalog.register_data(name="Sewer_ML_resized_100k", data_dict={"train_resized_100k": train_path, "test_resized_100k": val_path})
