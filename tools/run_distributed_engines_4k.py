...
train_path="/scratch/tyldzl/data/Sewer_ML/pretrain_4k"
val_path="/scratch/tyldzl/data/Sewer_ML/pretrain_4k"
VisslDatasetCatalog.register_data(name="Sewer_ML_4k", data_dict={"train": train_path, "val": val_path})
