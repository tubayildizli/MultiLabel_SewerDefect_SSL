...
-  With SSL pre-training (recommended), see [`fine_tuning/SSL_RN101_Finetuning_revision.ipynb`](./fine_tuning/SSL_RN101_Finetuning_revision.ipynb)

-  Or baseline (fully supervised), see [`fine_tuning/Fully_supervised_RN101_revision.ipynb`](./fine_tuning/Fully_supervised_RN101_revision.ipynb)
